...
<div class="container">
	...
	<form class="form-horizontal" name="myform" method="post" action="${pageContext.request.contextPath}/member/edit_ok.do" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="user_pw" class="col-md-2">현재비빌번호*</label>
			<div class="col-md-10">
		...
		<div class="form-group">
			<label for="new_user_pw" class="col-md-2">변경할 비빌번호</label>
			<div class="col-md-10">
				<input type="password"  name="new_user_pw" id="new_user_pw" class="form-control" 
				placeholder="변경을 원하실 경우만 입력하세요"/>
			</div>
		</div>
		
		<div class="form-group">
			<label for="new_pw_re" class="col-md-2">변경할 비빌번호 확인*</label>
			<div class="col-md-10">
		...
		<div class="form-group">
			<label for="gender1" class="col-md-2">생년월일 *</label>
			<div class="col-md-10">
			...
			<div class="col-md-10 col-md-offset-2">
				<p>
					...
					<label class="checkbox-inline">
						<input type="checkbox" name="img_del" id="img_del" value="Y" />이미지삭제
					</label>					
				</p>
				<script type="text/javascript">
					$(function() {
						//이미지가 등록된상태이므로, 파일의 신규 등록을 방지
